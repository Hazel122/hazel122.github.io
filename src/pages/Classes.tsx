...
const classes = [
  ...
  },
  {
    ...
    description: 'Principles and design of distributed systems, including communication, synchronization, and fault tolerance.',
    semester: '',
    instructor: '',
  ...
  {
    id: 8,
    title: 'CSE 461: Introduction to Computer Networks',
